...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('card-hover rounded-xl border border-slate-200/60 bg-white text-slate-950 shadow-sm hover:shadow-md', className)}
      {...props}
    />
  )
);
...
export const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn('section-heading text-base sm:text-lg', className)}
      {...props}
    />
  )
);
