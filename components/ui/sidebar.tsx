...
export function Sidebar({ userEmail = '', fullName = '', walletBalance = 0 }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile Top Header */}
      <div className="md:hidden flex h-14 items-center justify-between border-b border-slate-200 bg-white/90 backdrop-blur-md px-4 sticky top-0 z-30">
        ...
        <button
          ...
          className="rounded-lg p-1.5 text-slate-500 hover:bg-slate-50 hover:text-slate-900 border border-slate-200 transition-colors"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          <div
            ...
            onClick={closeSidebar}
          />
          <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white border-r border-slate-200 shadow-2xl z-50 animate-slide-in">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:flex md:w-60 md:flex-col md:fixed md:inset-y-0 bg-white border-r border-slate-200 shrink-0 z-20">
